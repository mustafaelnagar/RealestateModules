...

	{
...

	    {
	        ...
	        echo '<li class="'.$class.'" >
	                    ...
	                    <a href="'.$url.'">'.lang_key($page->title).'</a>
...

	        {
...

  		    	{
		            ...
		            echo "<li  >
		                        ...
		                        <a href='' rel='property-sub-menu'>".lang_key($page->title)."</a>  ";
...
<div class='sub-menu'>
	        ...
	        for($i=0;$i<$level;$i++)
	            ...
	            $after_content.= '</ul> </div> </li>';//end of subchild  // ustafa Adel Elnagar 
